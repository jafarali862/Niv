    ...
    public function showAssignForm($customerId)
{
    ...
    public function update(Request $request,$id)
    {
        ...
        //  InsuranceCustomer::find($id)->update([
        //     'company_id' => $request->company,
        //     'name' => $request->name,
        //     'father_name' => $request->father_name,
        //     'phone' => $request->phone,
...
// Update customer with or without new file
$customer->update([
    'company_id' => $request->company,
    'name' => $request->name,
    'father_name' => $request->father_name,
    ...
    'crime_number' => $request->crime_no,
    'police_station' => $request->police_station,
    'intimation_report' => $intimationReportPath, // ✅ include uploaded file path here
]);
    ...
    // // Handle file upload
    // $intimationReportPath = $customer->intimation_report; // Keep existing path by default
    ...
    //     if ($customer->intimation_report && Storage::disk('public')->exists($customer->intimation_report)) {
    //         Storage::disk('public')->delete($customer->intimation_report);
    //     }
    ...
    //     'crime_number' => $request->crime_no,
    //     'police_station' => $request->police_station,
    //     'intimation_report' => $intimationReportPath, // ✅ Store updated path
    // ]);
