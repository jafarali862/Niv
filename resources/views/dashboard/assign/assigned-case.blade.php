...
@section('content')
    <div class="container-fluid">
        <div class="text-right">
            ...
            <form method="GET" action="{{ route('assigned.case') }}" class="row g-3 mb-3">
    <div class="col-md-3">
                        ...
                        <tbody>
                            @foreach ($cases as $case)
                                <tr>
                                    ...
                                    @endif
                                    @if($case->case_status==1)
                                    <td><a href="{{route('re.assign.case', $case->id)}}" class="btn btn-primary"><i class="fa fa-retweet"></i></a></td>
                                    @else
                                    <td><button class="btn btn-danger"><i class="fa fa-window-close" aria-hidden="true"></i></button></td>
                                    @endif -->
