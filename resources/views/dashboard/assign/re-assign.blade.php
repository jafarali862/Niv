    ...
    <form action="{{ route('re.assign.update') }}" method="POST" id="caseUpdate">
     ...
     <div id="successMessage" class="alert alert-success" style="display: none;"></div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-4">
                    <label for="driver" class="form-label fw-bold">Select Executive (Driver)</label>
                ...
                <div class="mb-4">
                    <label for="spot" class="form-label fw-bold">Select Executive (Spot)</label>
                ...
                <div class="mb-4">
                    <label for="date" class="form-label fw-bold">Investigation Date</label>
            ...
            <div class="col-md-6">
                <div class="mb-4">
                    <label for="garage" class="form-label fw-bold">Select Executive (Garage)</label>
                ...
                <div class="mb-4">
                    <label for="meeting" class="form-label fw-bold">Select Executive (Meeting)</label>
                ...
                @if ($cases->type === 'MAC')
                <div class="mb-4">
                    <label for="accident_person" class="form-label fw-bold">Select Executive (Accident Person)</label>
