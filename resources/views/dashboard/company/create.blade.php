        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    ...
                    <button class="nav-link" id="garage-tab" data-bs-toggle="tab" data-bs-target="#garage" type="button" role="tab">Garage Data</button>
                    </li>
                    <li class="nav-item" role="presentation">
                ...
                <div class="tab-pane fade" id="garage" role="tabpanel"></div>
                <div class="tab-pane fade" id="driver" role="tabpanel"></div>
                <div class="tab-pane fade" id="spot" role="tabpanel"></div>
                <div class="tab-pane fade" id="meeting" role="tabpanel"></div>
...
<!--                     
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
      ...
      {
      const tabId = event.target.getAttribute('data-bs-target').substring(1); // e.g., "spot"
      ...
      .then(questions => {
      tabPane.innerHTML = `<h5 class="mb-3">${dataCategory.replace('_', ' ').toUpperCase()} Insurance Questions</h5>`;
      ...
      tabPane.dataset.loaded = 'true'; // Mark as loaded
      })
      .catch(error => {
      tabPane.innerHTML = `<p class="text-danger">Failed to load questions.</p>`;
      console.error(error);
      });
      });
      });
...
<script>
    ...
    // Optionally, load content via AJAX or unhide hidden blocks
    console.log("Tab switched to:", targetId);

    // Example: Show content dynamically if needed (pseudo-code)
    // if (targetId === "#driver" && !alreadyLoaded) { loadDriverContent(); }
    });
    });
    });
</script>
